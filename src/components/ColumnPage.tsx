    ...
    <div>
      ...
      <section className="border-b border-card-border bg-card-bg/50">
        <div className="max-w-4xl mx-auto px-4 md:px-8 pt-8 md:pt-10 pb-10 md:pb-16">
          ...
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 md:mb-6">{title}</h1>
        ...
        <section>
          ...
          <ul className="space-y-3">
            {keyArguments.map((arg, i) => (
              <li
                key={i}
                className="flex gap-3 border border-card-border rounded-lg p-3 md:p-4 bg-card-bg/50"
              >
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              {caseStudies.map((cs, i) => (
                <div
                  key={i}
                  className="border border-card-border rounded-lg p-4 md:p-5 bg-card-bg"
                >
          ...
          <section>
            ...
            <div className="space-y-3 md:space-y-4">
              {myths.map((m, i) => (
                ...
                >
                  <div className="bg-red-500/5 border-b border-card-border px-4 md:px-5 py-3">
                    <p>
                  ...
                  <div className="bg-green-500/5 px-4 md:px-5 py-3">
                    <p>
          ...
          <section>
            ...
            <div className="space-y-4">
              {quotes.map((q, i) => (
                <blockquote
                  key={i}
                  className="border-l-2 border-accent/40 pl-4 md:pl-5"
                >
